...
export function Manga() {
  ...
  const { 
    ...
    queryKey: ['manga-discover', sort, genre, debouncedQuery], 
    queryFn: ({ pageParam = 1 }) => api.discoverManga(pageParam, sort, genre, debouncedQuery),
    initialPageParam: 1,
  ...
  return (
    <SectionPageLayout 
      ...
      items={manga}
      emptyMessage="Nenhum mangá encontrado. A fonte Jikan (MyAnimeList) pode estar limitando as requisições (rate limit)."
      footer={
        hasNextPage && (
