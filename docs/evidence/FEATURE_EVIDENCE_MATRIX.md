...
| DETAIL-VIDEO-001 | Vídeos reais nos detalhes | PARTIAL | `DETAIL_VIDEOS.md`; normalização, lista, segurança e UI testadas | Jikan → YouTube reproduzido no modal desktop/Pixel 7 | TMDB sem chave; múltiplos vídeos ainda sem prova externa; browsers/a11y/tema claro |
